...
make generador_nasm-test
./test_generador_nasm fichero.asm
nasm -felf32 fichero.asm
nasm -felf32 ts_fichero.asm	
gcc -o fichero -g -m32 fichero.o ts_fichero.o olib.o
