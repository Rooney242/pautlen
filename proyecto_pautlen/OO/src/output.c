	...
	switch(caso){
		...
		case CASO_431:
			fprintf(pf,"CASO 43.1\n"
				"Buscar id cualificado instancia desde funcion global: ERR-> BUSCA UN ID QUE EXISTE COMO VARIABLE GLOBAL DE UNA CLASE\n"
				"QUE NO TIENE ESE ATRIBUTO");
			break;
		case CASO_433:
		...
		case CASO_521:
			fprintf(pf, "CASO 52.1\n"
				"Buscar para declarar miembro instancia: ERROR-> NO EXISTE EN LA CLASE PERO PUEDE QUE SI EN LA JERARQUIA Y\n"
				"NO ES ACCESIBLE. SE PUEDE DECLARAR");
			break; 
		case CASO_522:
			fprintf(pf, "CASO 52.2\n"
				"Buscar para declarar miembro instancia: OK-> NO EXISTE EN LA CLASE PERO PUEDE QUE SI EN LA JERARQUIA\n"
				"Y ES ACCESIBLR. NO SE PUEDE DECLARAR");
			break;
		case CASO_53:
			fprintf(pf, "CASO 53\n"
